...
public class Junit4Annotations {
    ...
    public static void SetInitialValues() {
        websiteUrl = "www.creovsys.com";
        System.out.println("[@BeforeClass] Setting Initial Values...\nWebsite URL is: " + websiteUrl + "\n");
    }
    //It runs before every test. Default user is always Ram
    @Before
    ...
    //Third test outputs "Ram" because I did not set another name to user value
    @Test
    public void T03_thirdTest() {
        System.out.println("[@Test] This is third test and user is: " + user + "\n");
    }
    //It runs at the end of each test classes and set user value to null
    @After
